 ...
 */
function aroid_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function aroid_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function aroid_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('aroid_sanitize_number')) :
    function aroid_sanitize_number($input)
    {
 ...
 *
 */
if ( !function_exists('aroid_sanitize_image') ) :
	function aroid_sanitize_image( $image, $setting ) {
		/*
