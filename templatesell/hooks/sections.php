 ...
 * @package Aroid
 */
if (!function_exists('aroid_add_main_header')) :
     ...
     * @since 1.0.0
     */
    function aroid_add_main_header()
    {
        get_template_part('template-parts/sections/header', 'section');        
    }
endif;
add_action('aroid_action_header', 'aroid_add_main_header', 10);
 ...
 * @package Aroid
 */
if (!function_exists('aroid_add_main_slider')) :
     ...
     * @since 1.0.0
     */
    function aroid_add_main_slider()
    {
        
        get_template_part('template-parts/sections/slider', 'section');
    }
endif;
add_action('aroid_action_slider', 'aroid_add_main_slider', 10);
 ...
 * @package Aroid
 */
if (!function_exists('aroid_boxes_section')) :
     ...
     * @since 1.0.0
     */
    function aroid_boxes_section()
    {       
        
        get_template_part('template-parts/sections/boxes', 'section');
    }
endif;
add_action('aroid_action_boxes', 'aroid_boxes_section', 10);

//only for blog and archive page
if( !function_exists( 'aroid_blog_sidebar_position_array' ) ) :
    /*
     * Function to get blog categories
     */
    function aroid_blog_sidebar_position_array() {
...
if( !function_exists( 'aroid_sidebar_position_array' ) ) :
    /*
     * Function to get blog categories
     */
    function aroid_sidebar_position_array() {
