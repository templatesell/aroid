...
if ( function_exists( 'register_block_pattern' ) ) {
	...
	if ( function_exists( 'register_block_pattern_category' ) ) {
		...
		register_block_pattern_category(
			'aroid',
			array( 'label' => esc_html__( 'Aroid', 'aroid' ) )
		);
	}
	...
	*/
	...
	register_block_pattern(
		'aroid/profile',
		array(
			'title'       => __( 'Author Profile', 'aroid' ),
			'categories'  => array( 'aroid' ),
			'keywords'    => array( __( 'Profile', 'aroid' ), __( 'User', 'aroid' ) ),
			'description' => __( 'A profile pattern with photo, text content, social media links and latest posts.', 'aroid' ),
			'content'     => '
...
/**
	...
	*/
	...
	register_block_pattern(
		'aroid/contact',
		array(
			'title'       => __( 'Contact Form', 'aroid' ),
			'categories'  => array( 'aroid' ),
			'keywords'    => array( __( 'Contact', 'aroid' ), __( 'User', 'aroid' ) ),
			'description' => __( 'A contact form pattern with form, email ,phone, etc.', 'aroid' ),
			'content'     => '
				<!-- wp:columns -->
