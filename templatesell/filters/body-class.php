...
add_filter('body_class', 'aroid_body_class');
function aroid_body_class($classes)
{
    $classes[] = 'at-sticky-sidebar';
    global $aroid_theme_options;
    
    if (is_singular()) {
        $sidebar = $aroid_theme_options['aroid-sidebar-single-page'];
    ...
    $sidebar = $aroid_theme_options['aroid-sidebar-blog-page'];
...
add_filter('body_class', 'aroid_layout_body_class');
function aroid_layout_body_class($classes)
{
    global $aroid_theme_options;
    $layout = $aroid_theme_options['aroid-column-blog-page'];
